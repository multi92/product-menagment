...
$keyword = $_GET['search'] ?? null; //ako search nije tamo izvadi empty string 

if ($keyword) {
    $statement = $pdo->prepare('SELECT * FROM products WHERE title like:keyword ORDER BY create_date DESC');
    $statement->bindValue(":keyword", "%keyword%"); //mysql simbol 
...
$statement->execute();
$products = $statement->fetchAll(PDO::FETCH_ASSOC); // fecovanje u asocijativnom nizu 
...
<form action="" method="GET">
    <div class="input-group mb-3">
        ...
        <div class="input-gruop-append">
            <button class="btn btn-succes" type="submit">search</button>
        </div>
    </div>
</form>
...
<table class="table">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                <a href="/products/update.php?id=<?php echo $product['id'] ?>"
